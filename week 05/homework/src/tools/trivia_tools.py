"""Tools for fetching trivia questions from Open Trivia Database API"""
...
class TriviaTools:
    """Tools for interacting with the Open Trivia Database API"""

    def get_categories(self) -> str:
        """Get all available trivia categories with their IDs.
        
        Returns:
            str: Formatted string with category ID and name
        """
    ...
    def get_questions(self, amount: int, category: int, difficulty: str) -> str:
        ...
        Returns:
            str: Formatted questions with correct and incorrect answers
        """
        params = {
            'amount': amount,
            'category': category,
